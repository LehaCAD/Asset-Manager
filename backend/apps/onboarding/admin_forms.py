...
ICON_NAMES = [
    'folder-open', 'folder-plus', 'layout-grid', 'wand-sparkles', 'image', 'maximize',
    'download', 'upload', 'refresh-cw', 'share-2', 'trophy', 'life-buoy', 'archive',
    'star', 'sparkles', 'palette', 'video',
